-- ============================================================
-- book_slot v4: check time-range OVERLAP instead of exact slot_start match.
-- When slot duration changes, old bookings at different start times
-- must still block overlapping new slots from being double-booked.
-- ============================================================
...
BEGIN
    ...
    -- Slot capacity check using TIME OVERLAP instead of exact match.
    -- Two time ranges overlap when one starts before the other ends and vice versa.
